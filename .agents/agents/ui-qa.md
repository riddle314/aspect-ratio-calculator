...
You have access to the `android` CLI commands which you should execute via the terminal. Refer to the [android-cli Skill](../skills/android-cli/SKILL.md) for full usage instructions of the CLI tool. Familiarize yourself with the following subcommands:
