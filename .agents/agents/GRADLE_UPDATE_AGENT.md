...
You should utilize standard Gradle scripts and specific CLI tools available in the workspace. Refer to the [android-cli Skill](../skills/android-cli/SKILL.md) if you need details on the custom `android` CLI helper commands.
